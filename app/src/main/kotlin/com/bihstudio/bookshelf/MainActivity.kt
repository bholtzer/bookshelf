...
private fun ComponentActivity.toSharedUri(uri: Uri, mimeType: String): com.bihstudio.bookshelf.presentation.share.SharedUri =
    com.bihstudio.bookshelf.presentation.share.SharedUri(
        uri = uri.toString(),
        mimeType = mimeType,
...
private fun String.toDeferredBookInviteText(): String? {
    ...
    val code = decoded.substringAfter("book_invite=", missingDelimiterValue = "")
        ...
        ?: return null
    return "bookshelf://book-invite/$code"
}
