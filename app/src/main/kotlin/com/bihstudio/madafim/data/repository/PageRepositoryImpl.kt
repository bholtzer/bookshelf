...
class PageRepositoryImpl @Inject constructor(
    ...
    private fun com.bihstudio.madafim.data.local.model.PageEntity.toFirestoreMap(
        downloadUrl: String?,
    ...
    private suspend fun PageEntity.withDownloadedFileIfAvailable(): PageEntity {
        ...
        val extension = when (pageType) {
            com.bihstudio.madafim.domain.model.PageType.PDF.name -> "pdf"
            com.bihstudio.madafim.domain.model.PageType.IMAGE.name -> remoteFileExtension(url)
            else -> return this
        }
